...
app.factory('NewsApp',['$http', 'Config', function($http, Config) {
	...
	data.getPosts = function (page, category) {
		if(category){
			...
			return $http(
				{
					method: 'GET', url:'http://52.66.147.226/coreapi/article.php'
				}
			);
		}
	},
	...
	data.getChannels = function () {
		return $http(
			{
				method: 'GET', url:'http://52.66.147.226/coreapi/channel.php'
			}
		);
	},
	data.channel = function (channelid) {
		return $http(
			{
				method: 'GET', url:'http://52.66.147.226/coreapi/channelid.php?channelid='+channelid
			}
		);
	},
